...
const citiesData = [
  ...
  {
    imgSrc:
      "https://images.pexels.com/photos/4046386/pexels-photo-4046386.png?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    country: "Italy",
    city: "Florence",
    popularPlaces: 10
  },
  {
    imgSrc:
      "https://images.pexels.com/photos/2044434/pexels-photo-2044434.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
  ...
  {
    imgSrc:
      "https://images.pexels.com/photos/572689/pexels-photo-572689.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    country: "New Zealand",
    city: "West Coast",
    popularPlaces: 12
  }
    ...
    <main>
      ...
      <div className="owl-carousel owl-theme" ref={carouselRef}>
        {citiesData.map((cityData, index) => {
          return <CarouselItem key={index} cityData={cityData} />;
        })}
      </div>
    </main>
  );
